...
@section('content')
	...
	{!! Form::open(['method' => 'GET', 'action' => 'NoticesController@confirm']) !!}
		...
		<div class="form-group">
			{!! Form::label('infringing_link', 'What is the link to where the this content is located.') !!}
		...
		<div class="form-group">
			{!! Form::label('original_description', 'And, finally, it might help to provide wome extra information related to this DMCA notice.') !!}
